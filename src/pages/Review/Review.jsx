...
const Review = () => {
    ...
    return (
        <div>
            <div className="container flex flex-col w-full max-w-xl p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-900 dark:text-gray-100 mb-5">
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <form onSubmit={reviewHandler}>
                            ...
                            <input type="submit" className='btn btn-success' value="Please review here" />
                        </form>
                    </div>
                </div>
            </div>
